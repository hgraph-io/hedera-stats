-- 072-associated_transactions_per_period.sql — per-period counts across all entity interactions
-- Moved from the legacy ecosystem schema; tracked in Hasura.

BEGIN;

---------------------------------
-- associated_transactions_per_period
---------------------------------
create or replace function ecosystem.associated_transactions_per_period (
...
select
  'associated_transactions_per_period' as name,
	period,
	int8range(
