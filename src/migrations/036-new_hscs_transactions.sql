-- 036-new_hscs_transactions.sql — baseline migration generated from src/metrics/transactions/new_hscs_transactions.sql.
-- Ordered so every ecosystem.* function it references already exists
-- (applies with check_function_bodies on).

BEGIN;

-- New HSCS transactions
CREATE OR REPLACE FUNCTION ecosystem.new_hscs_transactions (
  period TEXT,
