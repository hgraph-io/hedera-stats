-- 063-total_hscs_transactions.sql — baseline migration generated from src/metrics/transactions/total_hscs_transactions.sql.
-- Ordered so every ecosystem.* function it references already exists
-- (applies with check_function_bodies on).

BEGIN;

-- Total HSCS transactions
CREATE OR REPLACE FUNCTION ecosystem.total_hscs_transactions (
  period TEXT,
