-- 071-transactions_per_period.sql — per-period transaction counts for payer accounts
...
---------------------------------
create or replace function ecosystem.transactions_per_period (
...
with payer_transactions as (
	select consensus_timestamp from public.transaction
...
select
  'transactions_per_period' as name,
	period,
	int8range(
