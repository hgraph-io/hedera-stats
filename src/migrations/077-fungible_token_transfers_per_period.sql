-- 077-fungible_token_transfers_per_period.sql — per-period fungible token transfer counts
-- Moved from the legacy ecosystem schema; tracked in Hasura.

BEGIN;

---------------------------------
-- fungible_token_transfers_per_period
---------------------------------
create or replace function ecosystem.fungible_token_transfers_per_period (
    token_ids entity_id[],
    period text,
...
select
  'fungible_token_transfers_per_period' as name,
	period,
	int8range(
