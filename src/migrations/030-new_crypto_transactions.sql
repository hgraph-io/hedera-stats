-- 030-new_crypto_transactions.sql — baseline migration generated from src/metrics/transactions/new_crypto_transactions.sql.
...
CREATE OR REPLACE FUNCTION ecosystem.new_crypto_transactions (
  period TEXT,
