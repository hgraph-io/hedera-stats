...
create or replace function transactions_last_24hrs(is_init boolean default false)
returns bigint
...
select
	transactions_last_24hrs(not is_view_exists('transactions_last_24hrs')) as count,
