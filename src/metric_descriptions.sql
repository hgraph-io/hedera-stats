...
values
    ...
    ('hbar_total_released', 'The circulating (released) supply of HBAR tokens in tinybars, representing the amount available for use in the ecosystem.', 'Calculates released supply as total supply (50B HBAR) plus cumulative net flows from 548 designated treasury/system accounts since genesis. Treasury accounts include: 0.0.2 (primary treasury), 0.0.42, 0.0.44-71, 0.0.73-87, 0.0.99-100, 0.0.200-349, and 0.0.400-750. Negative flows from these accounts represent HBAR releases into circulation. Returns value in tinybars.'),
