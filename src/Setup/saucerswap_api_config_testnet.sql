-- ============================================================================
-- SaucerSwap API Configuration - TESTNET ONLY
-- ============================================================================
-- This file sets up API credentials for SaucerSwap integration on TESTNET.
-- ============================================================================
...
-- Insert SaucerSwap TESTNET API credentials ONLY
-- NOTE: Replace 'YOUR_TESTNET_API_KEY_HERE' with actual testnet API key
INSERT INTO ecosystem.api_config (service_name, environment, api_url, api_key)
VALUES 
    ('saucerswap', 'testnet', 'https://test-api.saucerswap.finance/tokens', 'YOUR_TESTNET_API_KEY_HERE')
...
-- Grant select permissions (functions need to read this)
GRANT SELECT ON ecosystem.api_config TO PUBLIC;

-- View current configuration (without exposing full API keys)
